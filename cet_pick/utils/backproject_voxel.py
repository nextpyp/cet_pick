...
def add_args(parser):
    ...
    group.add_argument('--last', type=int, default=10000, help='Backproject the first N images (default: %(default)s)')
...
def main(args):
    ...
    if args.ind:
        ...
        args.last = min(args.last, Nimg)
        iterator = np.arange(args.last, Nimg)
    # else:
    #     iterator = range(Nimg)
